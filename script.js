  ...
  return {
    ...
    class GameController {
        ...
        loadProgress() {
            try {
                ...
                if (saved && Array.isArray(saved.grid) && Number.isFinite(saved.level) && saved.playerName) {
                    ...
                    try { localStorage.setItem('playerName', saved.playerName); } catch(e) {}
                } else {
        ...
        bindUI() {
            ...
            safeAssign('expertBtn', () => { 
                ...
                // Tutorial deshabilitado por petición del usuario
                this.mode = 'experto'; 
                Config.MAX_LEVEL = 7;
        ...
        saveToLeaderboard() {
            ...
            try { localStorage.setItem('bubbleShooterLeaderboard', JSON.stringify(b.slice(0, 10))); } catch(e) {}
        }
    ...
    window.onload = function() { 
        ...
        try {
            ...
            console.log('Juego inicializado. Version 21-swap-fix');
        } catch(e) {
            alert('Error crítico en el juego:\n' + e.message);
            console.error(e);
        }        
